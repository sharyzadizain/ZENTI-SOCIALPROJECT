...
const INTRO_ANNOUNCEMENT_TEXT = "Давай познакомимся! Как тебя зовут? Просто скажи имя, или зажми кнопку «Ввести имя» на 5 секунд и напиши имя, я - запомню.";
...
function handlePointerDown(): void {
	...
	holdTimer = setTimeout(() => {
		...
		statusMessage.value = "Поле ввода открыто. Напиши имя.";
		nextTick(() => {
...
function ensureRecognition(): SpeechRecognitionLike | null {
	...
	instance.onresult = (event) => {
		...
		if (!transcript) {
			statusMessage.value = "Не расслышал имя. Нажми квадрат еще раз.";
			return;
		}
